...
{
echo "<script> document.location ='produk_barang_user.php' </script>";}
...
?>
<FORM METHOD="get" ACTION="produk_barang_user.php">
<CENTER><H1><font size="5">Tampil Data Barang</font></H1>
Cari Berdasarkan Jenis Barang : <INPUT TYPE="text" NAME="txtnama" value="<?php echo $txtnama;?>"> &nbsp;&nbsp;
...
echo "<td>".$brs[9]."</td>";
echo "<td>Rp.$brs[10]</td>";
$kd=$brs[0];
$jns=$brs1[1];
//echo "<td><a href='transaksi2.php?kd=$kd&jns=$jns&act=ubh'>BUY NOW</a></td>";
//echo "<td><A HREF='transaksi.php'><INPUT TYPE='submit' name='act' value='BUY NOW'></A></td>";
//$kd=$brs[0];
